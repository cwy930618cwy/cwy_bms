<template>
  <div class="content">
    ...
    >
      <div class="tableList">
        <el-form ref="addForm" :model="systemFormList" :rules="rules" label-width="80px">
          <el-form-item label="系统标识" prop="systemCode">
            <el-input placeholder="请输入系统标识" v-model="systemFormList.systemCode"></el-input>
          </el-form-item>
          <el-form-item label="系统名称" prop="systemName">
            <el-input placeholder="请输入系统名称" v-model="systemFormList.systemName"></el-input>
          </el-form-item>
          <el-form-item label="回调地址" prop="loginCallbackUrl">
            <el-input placeholder="请输入回调地址" v-model="systemFormList.loginCallbackUrl"></el-input>
          </el-form-item>
          <el-form-item label="备注" prop="remark">
            <el-input placeholder="请输入备注" v-model="systemFormList.remark"></el-input>
          </el-form-item>
        </el-form>
      </div>
