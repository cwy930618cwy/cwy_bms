<template>
  <div class="department">
    <div class="components_search">
      <el-input placeholder="部门名称" v-model="departmentList.deptName" clearable></el-input>
    ...
    <div class="contain">
      <div class="left">
        <el-tree
          ...
          highlight-current
          :props="navMenuProp"
          :default-expanded-keys="[departmentList.parentId ? departmentList.parentId : '']"
      ...
      <div class="right">
        ...
        >
          ...
          <el-table-column prop="tag" align="center" label="备注"></el-table-column>
          <el-table-column fixed="right" align="center" label="操作">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="getDepartmentDetail(scope.row.id)">编辑</el-button>
              <el-button type="danger" size="mini" @click="deleteDepartment(scope.row.id)">删除</el-button>
              <el-button
                type="primary"
                size="mini"
    ...
    >
      <div class="tableList">
        <el-form ref="departmentForm" :model="departmentFormList" :rules="rules" label-width="80px">
          <el-form-item label="部门名称" prop="deptName">
            <el-input placeholder="请输入部门名称" v-model="departmentFormList.deptName"></el-input>
          </el-form-item>
          <el-form-item label="排序" prop="sort">
            <el-input placeholder="请输入排序" v-model="departmentFormList.sort"></el-input>
          </el-form-item>
          <el-form-item label="备注" prop="tag">
            <el-input placeholder="请输入备注" v-model="departmentFormList.tag"></el-input>
          </el-form-item>
        </el-form>
      </div>
    ...
    <el-dialog title center :visible.sync="showDepartmentDialog" @close="closeShowForm" width="30%">
      <div class="show">
        <div class="showList">
...
export default class department extends Vue {
  ...
  // 添加按钮点击显示弹窗
  addDepartment() {
    if (this.departmentList.parentId == null) {
      this.$message({
        message: '请选择部门',
        type: 'warning',
      })
  ...
  handleSizeChange(val: any) {
    this.departmentList.length = val
  }
  ...
  closeDepartmentForm() {
    ...
    ;(this.$refs.departmentForm as any).clearValidate()
  ...
  postDepartmentUpdate() {
    ...
    postDeptUpdate(params).then((response: any) => {
      this.postDepartmentList()
      this.closeDepartmentForm()
    })
  }
